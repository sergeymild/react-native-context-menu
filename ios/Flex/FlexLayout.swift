...
public final class Flex {
    ...
    */
    ...
    public func findView(by id: String) -> Flex? {
        if view?.flexId == id { return view?.flex }
        let subviews = view?.subviews ?? []
        for subview in subviews {
            if let v = subview.flex.findView(by: id) {
                return v
            }
        }
        return nil
     ...
     */
    @discardableResult
    public func addItem(id: String? = nil) -> Flex {
        let view = UIView()
        return addItem(view, id: id)
    }
     ...
     */
    @discardableResult
    public func addItem(_ view: UIView, id: String? = nil) -> Flex {
        if let host = self.view {
            host.addSubview(view)
            if let id = id { view.flexId = id }
            return view.flex
        } else {
    ...
    @discardableResult
    public func appendItem(_ view: UIView, id: String? = nil) -> Flex {
        if let host = self.view {
            host.addSubview(view)
            if let id = id { view.flexId = id }
            return self
    ...
    */
    ...
    public func isIncludedInLayout(_ included: Bool) -> Flex {
        ...
        view?.isHidden = !included
        return self
    }
    
    @discardableResult
    public func isEnabled(_ enabled: Bool) -> Flex {
        self.isIncludedInLayout = enabled
    ...
    */
    @discardableResult
    public func direction(_ value: Direction, if: Bool = true) -> Flex {
        if `if` { yoga.flexDirection = value.yogaValue }
        return self
    }
    ...
    */
    ...
    @discardableResult
    public func centerChildren() -> Flex {
        yoga.justifyContent = JustifyContent.center.yogaValue
        yoga.alignItems = AlignItems.center.yogaValue
        return self
    }
     ...
     */
    @discardableResult
    public func alignItems(_ value: AlignItems, if: Bool = true) -> Flex {
        if `if` { yoga.alignItems = value.yogaValue }
        return self
    }
    ...
    */
    @discardableResult
    public func alignSelf(_ value: AlignSelf, if: Bool = true) -> Flex {
        if `if` { yoga.alignSelf = value.yogaValue }
        return self
    }
    ...
    */
    ...
    @discardableResult
    public func flex(_ value: CGFloat) -> Flex {
        yoga.flexGrow = value
    ...
    */
     ...
     */
    @discardableResult
    public func marginStart(_ value: CGFloat, if: Bool = true) -> Flex {
        if `if` { yoga.marginStart = YGValue(value) }
        return self
    }
    
    @discardableResult
    public func marginStart(_ percent: FPercent, if: Bool = true) -> Flex {
        if `if` { yoga.marginStart = YGValue(value: Float(percent.value), unit: .percent) }
        return self
    }
     ...
     */
    @discardableResult
    public func marginEnd(_ value: CGFloat, if: Bool = true) -> Flex {
        if `if` { yoga.marginEnd = YGValue(value) }
        return self
    }
    
    @discardableResult
    public func marginEnd(_ percent: FPercent, if: Bool = true) -> Flex {
        if `if` { yoga.marginEnd = YGValue(value: Float(percent.value), unit: .percent) }
        return self
    }
...
public extension UILabel {
    func setFlex(text: String?) {
            self.text = text
            flex.markDirty()
            flex.isIncludedInLayout(text?.isEmpty != true)
        }
}

public extension UIImageView {
    func setFlex(image: UIImage, tint: UIColor? = nil) {
        self.image = image
